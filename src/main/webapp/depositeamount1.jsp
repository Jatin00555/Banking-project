...
Transactiondto td1=ts.depositeFund(td);
...
if(result.equalsIgnoreCase("success"))
{
	...
	out.println("<center><font color=light yellow font size=5>Amount of   Rs:   "+amount+"   Deposited successfully..</font></center><br>");
	out.println("<center><font color=light yellow font size=5>To Account No  [   "+ac1+"  ]</font></center><br>");
	out.println("<center><font color=light yellow font size=5>Avalible Balance  [ "+amount1+" ]</font></center><br>");
	out.println("<center><a href=\"depositeamount.jsp\"><button> Deposite Again</button></a></center>");
}
if(result.equalsIgnoreCase("failed"))
{
	out.println("<center><font color=light yellow font size=5>Amount of   Rs:   "+amount+"   Deposited Failed..</font></center><br>");
...
{
	out.println("<center><font color=light yellow font size=5>Amount of   Rs: "+amount+"  Deposited Failed Due To Exception..</font></center><br>");
